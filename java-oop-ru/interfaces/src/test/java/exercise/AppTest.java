...
class AppTest {
    ...
    void testReversedSequenceToString(){
        assertThat(new ReversedSequence("abcdef").toString()).isEqualTo("fedcba");
    }

    @Test
    void testReversedSequenceCharAt(){
        assertThat(new ReversedSequence("abcdef").charAt(1)).isEqualTo('e');
    }

    @Test
    void testReversedSequenceLength(){
        assertThat(new ReversedSequence("abcdef").length()).isEqualTo(6);
    }

    @Test
    void testReversedSequenceSubSequence(){
        assertThat(new ReversedSequence("abcdef").subSequence(1,4).toString()).isEqualTo("edc");
    }
    // END
}
