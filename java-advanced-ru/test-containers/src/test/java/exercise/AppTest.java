...
public class AppTest {
    ...
    void testShowPersons() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).contains("Simpson", "Doe", "Lock", "Smith");
    }
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(patch("/people/3")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\": \"Ellen\", \"lastName\": \"Ripley\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("Ellen", "Ripley");
    }
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(null);
      }
}
