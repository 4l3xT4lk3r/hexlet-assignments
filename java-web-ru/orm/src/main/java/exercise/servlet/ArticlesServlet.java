...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        // BEGIN
        List<Article> articles = new QArticle().setFirstRow(offset)
    ...
    private void newArticle(HttpServletRequest request,
        ...
        // BEGIN
        List<Category> categories = new QCategory().orderBy().name.asc().findList();
    ...
    private void createArticle(HttpServletRequest request,
        ...
        // BEGIN
        Category category = new QCategory().id.equalTo(Integer.parseInt(categoryId)).findOne();
